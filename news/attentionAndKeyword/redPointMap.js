...
require([
    ...
    //红色点
    var CustomLayerView2DRedPoint = BaseLayerViewGL2D.createSubclass({
        ...
        attach: function () {
            ...
            var fragmentSource =
                ...
                "const vec3 COLOR = vec3(1.00, 0.00, 0.00);" +
    ...
    CustomLayerRedPoint = GraphicsLayer.createSubclass({
        createLayerView: function (view) {
            if (view.type === "2d") {
                return new CustomLayerView2DRedPoint({
                    view: view,
                    layer: this
                });
            }
