...
require([
    ...
    //紫色点
    var CustomLayerView2DPurplePoint = BaseLayerViewGL2D.createSubclass({
        ...
        attach: function () {
            ...
            var fragmentSource =
                ...
                "const vec3 COLOR = vec3(0.62, 0.20, 0.78);" +
    ...
    CustomLayerPurplePoint = GraphicsLayer.createSubclass({
        createLayerView: function (view) {
            if (view.type === "2d") {
                return new CustomLayerView2DPurplePoint({
                    view: view,
                    layer: this
                });
            }
