    ...
    function echartsMapInit() {
        ...
        for (var i = 0; i < features.length; i++) {
            echartsInfos.push({
                ...
                content: '<div id="info' + i + '" style="height:150px;width:300px;position:absolute;z-index: 1"></div>',
                //div的id唯一标识
                id: "info" + i,
                echartsObj: null,
                option: {
                    ...
                    series: [{
                        name: "正面报导",
                        type: "bar",
                        data: [features[i].attributes.positive],
                        itemStyle: {
                            color: "#90EE90"
                        }
                    }, {
                        name: "负面报导",
                        type: "bar",
                        data: [features[i].attributes.negative],
                        itemStyle: {
                            color: "#810D70"
                        }
                    }]
